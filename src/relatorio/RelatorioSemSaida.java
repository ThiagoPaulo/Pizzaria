...
/**
 *Relatorio que contem os sabores que não foram vendidos
 * @author note
 */
public class RelatorioSemSaida extends Relatorio{
     ...
     * @param C = Cardapio
     */
    public RelatorioSemSaida(Cardapio C){
        this.cardapio = C;
   ...
   /**
    ...
    protected String imprimirRodape(){
        ...
        String frase = "Você deveria rever estes sabores!!:\t";
        return frase;
    };
    /**
